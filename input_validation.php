...
<?php
    ...
    $continue_button= "<form action=\"$run_url\" method=\"post\"><input type=\"hidden\" name = \"code\" value=\"$code\">   <input type=\"hidden\" name=\"kmer_length\" value=\"$kmer_length\" name=\"max_kmer_cov\" value=\"$max_kmer_cov\">  <input type=\"hidden\" name=\"read_length\" value=\"$read_length\">   <button type=\"submit\" class=\"center btn btn-success\">Continue</button></form>";
